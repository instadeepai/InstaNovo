...
To contribute to this project, you need a local conda environment to run `pre-commit` and other
tools locally.

If conda isn't installed on you machine, refer to the installation instruction for
[conda](https://docs.conda.io/projects/conda/en/latest/user-guide/install/index.html) or
[miniconda](https://docs.conda.io/en/latest/miniconda.html).

Create the conda environment and install `pre-commit`:

```shell
conda env create -f environment.yml
conda activate dtu-denovo-sequencing  # replace by the name indicated in environment.yml
